...
function Home() {
    ...
    const handleSelectAffiliation = (affiliationName: string) => {
        ...
        navigate("/bounty", { state: {characters: results, side: affiliationName } });
    };

    return (
        <>
            <main className="contenent-home-card">
                <h1 className="title-home-page">CHOOSE YOUR <br/> BOUNTIES</h1>
                <section className="contenent-card">
                    ...
                    <img className="logo-home-page-sun" src={Soleil} alt="" />
                        ...
                        <p className="text-home-card">Seek connection through wisdom, diplomacy, and the <br/> preservation of peace across the stars.</p>
                        <button  className="btn-home-page-light" onClick={() => handleSelectAffiliation("Jedi Order")}>
                            LIGHT SIDE
                        </button>
                    </div> 

                    <div className="card-dark-side" 
                    style={{
                        ...
                        <p className="text-home-card">Forge bonds through passion, strength, and the <br/>unyielding pursuit of galactic dominance.</p>
                        <button className="btn-home-page-dark" onClick={() => handleSelectAffiliation("Sith")}>
                            DARK SIDE
                        </button>
                    </div>
                </section>
